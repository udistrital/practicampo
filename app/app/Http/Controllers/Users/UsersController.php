        ...
        try
        {
            ...
            switch($filter)
            {
                case 'act':
                    ...
                    'us.segundo_apellido','ro.role', 'us.email', 'us.tiene_firma')
                ...
                case 'all':
                    ...
                    'us.primer_apellido', 
                    'us.segundo_apellido','ro.role', 'us.email', 'us.tiene_firma')->paginate(10);
                    break;
                default;
            }
    ...
    public function buscador(Request $request)
    {
        ...
        if($request && ($request->get('searchText')) != null)
        {
            ...
            ->select('users.id as id','users.primer_nombre','users.segundo_nombre','users.primer_apellido','users.segundo_apellido',
                     'users.usuario','tp_ident.sigla','tp_vinc.tipo_vinculacion','users.email','rl.role')
