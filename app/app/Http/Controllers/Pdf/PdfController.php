...
class PdfController extends Controller
{
    ...
    public function exportResolucionPdf($ids)
    {
        ...
        $docentes_practica=docentes_practica::whereIn('id',$list_solic)->get();
        ...
        ->select('p_prel.id','p_aca.programa_academico','e_aca.espacio_academico', 'e_aca.codigo_espacio_academico',
                ...
                'tip_ident.tipo_identificacion','users.id as id_user',
        ...
        foreach($solicitudes_practica as $sol)
        {
            ...
            if($sol->tipo_ruta == 1){
                ...
                $espa_pract_int[] =['id_proy'=>$pract_inte->id,'espacio_academico'=>$sol->espacio_academico,
                'codigo_espacio_academico'=>$sol->codigo_espacio_academico,'id_docente'=>$sol->id_docente_responsable];
            ...
            {
                if($item->total_personal_apoyo > 0)
                {
                ...
                else if($item->total_personal_apoyo == 0)
                {
                    $total_asistentes[$contador-1] = ['id_proy'=>$sol->id,
                                                        'num_estudiantes'=>$sol->num_estudiantes,
                                                        'num_docentes'=>1 + $pract_inte->cant_espa_aca];
        ...
        // {
            ...
            $coord = DB::table('users')
                    ->select('users.firma_litografica','users.tiene_firma',
                            DB::raw('CONCAT_WS(" ",users.primer_nombre, users.segundo_nombre, users.primer_apellido, users.segundo_apellido) as full_name'))
                    ->join('roles as rol','users.id_role','rol.id')
                    ->where('rol.role','=',"Coordinador")->orWhere('rol.id','=',4)
                    ->where('id_estado','=',1)
            ...
            $docentes_acompaniantes = DB::table('docentes_practica as acompa')
                                       ->select('acompa.id','acompa.numero_docentes_apoyo','acompa.num_doc_personal_apoyo_1','acompa.num_doc_personal_apoyo_2','acompa.num_doc_personal_apoyo_3','acompa.num_doc_personal_apoyo_4','acompa.num_doc_personal_apoyo_5','acompa.num_doc_personal_apoyo_6','acompa.num_doc_personal_apoyo_7','acompa.num_doc_personal_apoyo_8','acompa.num_doc_personal_apoyo_9','acompa.num_doc_personal_apoyo_10','acompa.docente_apoyo_1','acompa.docente_apoyo_2','acompa.docente_apoyo_3','acompa.docente_apoyo_4','acompa.docente_apoyo_5','acompa.docente_apoyo_6','acompa.docente_apoyo_7','acompa.docente_apoyo_8','acompa.docente_apoyo_9','acompa.docente_apoyo_10')
                            ->where('acompa.id','=',$id)->first();
            ...
            if($docentes_acompaniantes->total_personal_apoyo==0)
            {
                $acompa[] = ["nombre"=>"N/A",
                            "identificacion"=>"N/A",
                            "tipo"=>"N/A",
            ...
            if($docentes_acompaniantes->personal_apoyo_1!=Null)
            {
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_3)==Null?"":"Apoyo",
            //                 "num_apoyo"=>3];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_4)==Null?"":"Apoyo",
            //                 "num_apoyo"=>4];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_5)==Null?"":"Apoyo",
            //                 "num_apoyo"=>5];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_6)==Null?"":"Apoyo",
            //                 "num_apoyo"=>6];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_7)==Null?"":"Apoyo",
            //                 "num_apoyo"=>7];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_8)==Null?"":"Apoyo",
            //                 "num_apoyo"=>8];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_9)==Null?"":"Apoyo",
            //                 "num_apoyo"=>9];
            // }
            ...
            //                 "tipo"=>($docentes_acompaniantes->docente_apoyo_10)==Null?"":"Apoyo",
            //                 "num_apoyo"=>10];
            // }
            ...
            $num_apoyo = $docentes_acompaniantes->total_personal_apoyo;
    ...
    public function exportTransportePdf($ids)
    {
        ...
        ->select('p_prel.id','p_aca.programa_academico','e_aca.espacio_academico', 'e_aca.codigo_espacio_academico',
                ...
                'sol_prac.num_estudiantes', 'sol_prac.num_acompaniantes_apoyo',
                'p_prel.cantidad_grupos', 'sol_prac.fecha_salida','sol_prac.fecha_regreso','sol_prac.duracion_num_dias',
                'transp.cant_transporte_rp', 'transp.cant_transporte_ra', 'transp.det_tipo_transporte_rp', 'transp.det_tipo_transporte_ra', 
                'transp.exclusiv_tiempo_rp', 'transp.exclusiv_tiempo_ra','sol_prac.cronograma', 'sol_prac.observaciones', 
                'sol_prac.justificacion', 'sol_prac.objetivo_general', 'sol_prac.metodologia_evaluacion',
                'sol_prac.tipo_ruta','sol_prac.id as id_solicitud', 'sol_prac.num_resolucion','sol_prac.fecha_resolucion',
                'sol_prac.num_cdp', 'p_prel.num_acta_consejo_facultad', 'p_prel.fecha_acta_consejo_facultad',
        ...
        $docentes_acompaniantes = DB::table('docentes_practica as acompa')
        ->select('acompa.id','acompa.total_personal_apoyo','tp_p_apoyo_1.tipo_personal_apoyo as tp_p_apoyo_1','acompa.num_doc_personal_apoyo_2',
        'acompa.personal_apoyo_1','tp_p_apoyo_2.tipo_personal_apoyo as tp_p_apoyo_2','acompa.num_doc_personal_apoyo_2','acompa.personal_apoyo_2')
        ->join('tipo_personal_apoyo as tp_p_apoyo_1','acompa.id_tipo_personal_apoyo_1','tp_p_apoyo_1.id')
        ->join('tipo_personal_apoyo as tp_p_apoyo_2','acompa.id_tipo_personal_apoyo_2','tp_p_apoyo_2.id')
        ->where('acompa.id','=',$id)->first();
    ...
    public function exportOficioPdf($ids)
    {
        ...
        $list_pract_inte=DB::table('practicas_integradas as prac_int')
            ...
            ->join('proyeccion_preliminar as proy_prel','prac_int.id','proy_prel.id')
            ->join('solicitud_practica as sol_prac','proy_prel.id','sol_prac.id_proyeccion_preliminar')
            ->whereIn('proy_prel.id',$list_solic)->get();
