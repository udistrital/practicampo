            ...
            if(Auth::user()->id == $proyeccion_preliminar->id_docente_responsable || Auth::user()->id_role == 1)
            {
                ...
                /**Ruta Principal */
                    if($tipo_ruta == 1)
                    {
                        ...
                        $solicitud_practica->fecha_regreso= $proyeccion_preliminar->fecha_regreso_aprox_rp;
                        ...
                        /**Tabla costos_proyeccion RP*/
                            ...
                            $costos_proyeccion->vlr_guias_baquianos_rp;
                            $costos_proyeccion->vlr_otros_boletas_rp;
                            $costos_proyeccion->$viaticos_estudiantes_rp;
                            $costos_proyeccion->$viaticos_docente_rp;
                            $costos_proyeccion->total_presupuesto_rp=$vlr_materiales_rp+$viaticos_estudiantes_rp+$viaticos_docente_rp+$nuevo_costo_total_transporte_menor_rp+$valor_estimado_transporte_rp;
                        /**Tabla costos_proyeccion RP*/
                ...
                /**Ruta Alterna */
                    else if($tipo_ruta == 2)
                    {
                        ...
                        $solicitud_practica->fecha_regreso= $proyeccion_preliminar->fecha_regreso_aprox_ra;
                        ...
                        /**Tabla costos_proyeccion RA*/
                            ...
                            $costos_proyeccion->vlr_guias_baquianos_ra;
                            $costos_proyeccion->vlr_otros_boletas_ra;
