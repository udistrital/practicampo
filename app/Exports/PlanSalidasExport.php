...
class PlanSalidasExport implements ShouldAutoSize, WithTitle, FromArray, WithStyles, WithDrawings, WithColumnWidths
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells('B13:B14');$sheet->mergeCells('C13:C14');$sheet->mergeCells('D13:D14');$sheet->mergeCells('E13:E14');
        $sheet->mergeCells('F13:F14');$sheet->mergeCells('G13:G14');$sheet->mergeCells('H13:H14');$sheet->mergeCells('I13:I14');
        $sheet->mergeCells('J13:J14');$sheet->mergeCells('K13:K14');$sheet->mergeCells('L13:L14');$sheet->mergeCells('M13:M14');
