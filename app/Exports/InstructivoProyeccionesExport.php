...
class InstructivoprogramacionesExport implements FromCollection,  ShouldAutoSize, WithEvents, WithTitle 
{
    ...
    public function collection()
    {
        return collect([
            [''],
            ['','INSTRUCTIVO PARA DILIGENCIAR FORMATO DE programacionES PRELIMINARES'],
            ...
            ['','RECUERDE: NO SE DEBE CAMBIAR EL NOMBRE DEL DOCUMENTO, ESTE DEBE SER "programacionES_PRELIMINARES" EN MINÚSCULA TODO.'],
            [''],
