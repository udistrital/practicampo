...
//         $filter = "";
//         $nueva_programacion = "";
//         Mail::bcc($emails)->send(new CodigoMail($filter, $nueva_programacion));
//     }
...
//             Mail::bcc($email)->send(new CodigoMail($filter,$nueva_programacion,$nueva_solicitud, $email, $correos_administrativos));
//         }  
//     }
