        ...
        {   
            ...
            case 2:
                switch($filter)
                {
                    ...
                    case 'pend':
                        $proyeccion=DB::table('s2_pend')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                    ...
                    case 'aprob':
                        $proyeccion=DB::table('s2_aprob')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                        //->where('sol_prac.id_estado_solicitud_practica','=',3)
                    ...
                    case 'all':
                        $proyeccion=DB::table('s2_all')->paginate(10000);
						//->where('p_prel.id_estado','=',1)
                        //->where('sol_prac.listado_estudiantes','=',1)
            ...
            case 3:
                ...
                {
                    case 'pend':
                        $proyeccion=DB::table('s3_pend')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                    ...
                    case 'pend-teso':
                        $proyeccion=DB::table('s3_pend-teso')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                        //->where('sol_prac.id_estado_solicitud_practica','=',3)
                    ...
                    case 'pend-cierre':
                        $proyeccion=DB::table('s3_pend-cierre')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                        //->where('sol_prac.id_estado_solicitud_practica','=',3)
                    ...
                    case 'enc_trans':
                        $proyeccion=DB::table('s3_enc_trans')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                        //->where('sol_prac.id_estado_solicitud_practica','=',3)
                    ...
                    case 'aprob':
                        $proyeccion=DB::table('s3_aprob')->paginate(10000);
						//->where('aprobacion_consejo_facultad','=',3)
                        //->where('sol_prac.aprobacion_coordinador','=',7)
                        //->where('sol_prac.aprobacion_asistD','=',7)
                        //->where('sol_prac.id_estado_solicitud_practica','=',3)
                    ...
                    case 'all':
                        $proyeccion=DB::table('s3_all')->paginate(10000);
            ...
            case 5:
                switch($filter)
                {
                    case 'pre-proy':
                        $usuario=DB::table('users')->where('id','=',$idUser)->first();
                        $id_prog_coord = $usuario->id_programa_academico_coord;
                        $proyeccion=DB::table('s5_pre-proy')
                    ...
                    case 'proy-comp':
                        $usuario=DB::table('users')->where('id','=',$idUser)->first();
                        $proyeccion=DB::table('s5_proy-comp')                       
						->where('id_docente_responsable','=',$idUser)
                        ->paginate(10000);
						//->where('p_prel.confirm_creador','=',1)
                        //->where('p_prel.confirm_docente','=',1)
                    ...
                    case 'sol_recha':
                        $espacios = DB::table('espacio_academico as esp_aca')
                        ->where('electiva','=',1)->get();
                        $proyeccion=DB::table('s5_sol_recha')
						->where('id_docente_responsable','=',$idUser)
                        ->paginate(10000);                     
                        //->where('aprobacion_consejo_facultad','=',3)
                        //->where('p_prel.id_estado','=',1)
