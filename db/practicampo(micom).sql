...
CREATE TABLE IF NOT EXISTS `programacion_practica` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_programacion_practica_users_idx` (`id_docente_responsable`),
  KEY `fk_programacion_practica_espacio_academico_idx` (`id_espacio_academico`),
  KEY `fk_programacion_practica_tipo_transporte_idx` (`id_tipo_transporte_rp_1`),
  KEY `fk_programacion_practica_periodo_academico_idx` (`id_peridodo_academico`),
  KEY `fk_programacion_practica_semestre_asignatura_idx` (`id_semestre_asignatura`),
  KEY `fk_programacion_practica_tipo_zona_transitar_idx` (`id_tipo_zona_transitar`),
  KEY `fk_programacion_practica_estado_coord_idx` (`aprobacion_coordinador`),
  KEY `fk_programacion_practica_estado_dec_idx` (`aprobacion_decano`),
  KEY `fk_programacion_practica_programa_academico_idx` (`id_programa_academico`),
  CONSTRAINT `fk_programacion_practica_espacio_academico` FOREIGN KEY (`id_espacio_academico`) REFERENCES `espacio_academico` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_estado_coord` FOREIGN KEY (`aprobacion_coordinador`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_estado_dec` FOREIGN KEY (`aprobacion_decano`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_periodo_academico` FOREIGN KEY (`id_peridodo_academico`) REFERENCES `periodo_academico` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_programa_academico` FOREIGN KEY (`id_programa_academico`) REFERENCES `programa_academico` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_semestre_asignatura` FOREIGN KEY (`id_semestre_asignatura`) REFERENCES `semestre_asignatura` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_tipo_transporte` FOREIGN KEY (`id_tipo_transporte_rp_1`) REFERENCES `tipo_transporte` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_tipo_zona_transitar` FOREIGN KEY (`id_tipo_zona_transitar`) REFERENCES `tipo_zona_transitar` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_programacion_practica_users` FOREIGN KEY (`id_docente_responsable`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

REPLACE INTO `programacion_practica` (`id`, `id_tipo_transporte_rp_1`, `id_tipo_transporte_rp_2`, `id_tipo_transporte_rp_3`, `id_tipo_transporte_ra_1`, `id_tipo_transporte_ra_2`, `id_tipo_transporte_ra_3`, `id_programa_academico`, `id_docente_responsable`, `id_espacio_academico`, `id_peridodo_academico`, `id_semestre_asignatura`, `id_tipo_zona_transitar`, `ruta_principal`, `destino_rp`, `ruta_alterna`, `destino_ra`, `lugar_salida_rp`, `lugar_salida_ra`, `lugar_regreso_rp`, `lugar_regreso_ra`, `fecha_salida_aprox_rp`, `fecha_salida_aprox_ra`, `fecha_regreso_aprox_rp`, `fecha_regreso_aprox_ra`, `num_estudiantes_aprox`, `num_acompaniantes`, `observ_coordinador`, `observ_decano`, `det_recorrido_interno_rp`, `det_recorrido_interno_ra`, `det_tipo_transporte_rp_1`, `otro_tipo_transporte_ra_1`, `otro_tipo_transporte_ra_2`, `otro_tipo_transporte_ra_3`, `otro_tipo_transporte_rp_1`, `otro_tipo_transporte_rp_2`, `otro_tipo_transporte_rp_3`, `det_tipo_transporte_rp_2`, `det_tipo_transporte_rp_3`, `det_tipo_transporte_ra_1`, `det_tipo_transporte_ra_2`, `det_tipo_transporte_ra_3`, `num_paradas_trayecto`, `cantidad_grupos`, `grupo_1`, `grupo_2`, `grupo_3`, `grupo_4`, `duracion_num_dias_rp`, `duracion_num_dias_ra`, `viaticos_estudiantes`, `viaticos_docente`, `costo_total_transporte`, `cant_transporte_rp`, `cant_transporte_ra`, `capac_transporte_rp_1`, `capac_transporte_rp_2`, `capac_transporte_rp_3`, `capac_transporte_ra_1`, `capac_transporte_ra_2`, `capac_transporte_ra_3`, `exclusiv_tiempo_rp_1`, `exclusiv_tiempo_rp_2`, `exclusiv_tiempo_rp_3`, `exclusiv_tiempo_ra_1`, `exclusiv_tiempo_ra_2`, `exclusiv_tiempo_ra_3`, `aprobacion_coordinador`, `aprobacion_decano`, `fecha_diligenciamiento`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `solicitud_practica` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_programacion_practica` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_solicitud_practica_programacion_practica_idx` (`id_programacion_practica`),
  ...
  CONSTRAINT `fk_solicitud_practica_programacion_practica` FOREIGN KEY (`id_programacion_practica`) REFERENCES `programacion_practica` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
