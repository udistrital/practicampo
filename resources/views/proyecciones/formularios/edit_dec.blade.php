...
<!-- valor estimado transporte -->
    <div class="form-group row">
        <div class="col-md-6">
            ...
            value="{{ number_format($costos_proyeccion->valor_estimado_transporte_rp,'0',',','.')}}" required autocomplete="off" autofocus readonly>
        ...
        <div class="col-md-6">
            ...
            value="{{ number_format($costos_proyeccion->valor_estimado_transporte_ra,'0',',','.')}}" required autocomplete="off" autofocus readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <?php if($proyeccion_preliminar->aprobacion_coordinador == 7) echo 'checked'?>  disabled>
        ...
        <!-- 20 -->
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    title="" autocomplete="off" autofocus><?php echo $proyeccion_preliminar->observ_decano?></textarea>
