    ...
    <!-- guías -baquianos -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_proyeccion->det_guias_baquianos_rp}}" autocomplete="off" autofocus readonly>
    ...
    <!-- otros - boletas -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_proyeccion->det_otros_boletas_rp}}" autocomplete="off" autofocus readonly>
    ...
    <!-- guías -baquianos -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_proyeccion->det_guias_baquianos_ra}}" autocomplete="off" autofocus readonly>
    ...
    <!-- otros - boletas -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_proyeccion->det_otros_boletas_ra}}" autocomplete="off" autofocus readonly>
    ...
    <!-- Decano -->
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    title="" autocomplete="off" autofocus readonly>{{$proyeccion_preliminar->observ_decano}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <?php if($proyeccion_preliminar->aprobacion_consejo_facultad == 3) echo 'disabled'?> disabled>
