    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header" id="num_docen" name="{{$proyeccion_preliminar->id_docente_responsable}}">{{ __('Realizar cambios a Proyección Preliminar N° ') }}<?php echo $proyeccion_preliminar->id?><?php echo "\t - "?>
                    ...
                    <div class="row">                        
                        ...
                        <div class="form-group row mb-5">
                                <label class="switch">
                                    <input type="checkbox" name="habilitar_cambios" id="habilitar_cambios" onchange="habilitar_inputs_cambios('cambios_proyeccion')" value="0">
                     ...
                     Habilitar cambios -->
                    <form method="POST" action="{{ route('proy_cambios',Crypt::encrypt($proyeccion_preliminar->id)) }}" id="cambios_proyeccion">
                    @method('PUT')
                    @csrf  
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select name="docentes_activos" class="form-control" required >
                                            @foreach($docentes_activos as $doc_act)
                                                <option <?php if($doc_act->id==$proyeccion_preliminar->id_docente_responsable) echo 'selected'?> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$proyeccion_preliminar->cantidad_url_rp}}" autocomplete="off" autofocus  >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$proyeccion_preliminar->ruta_principal_2}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$proyeccion_preliminar->ruta_principal_3}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$proyeccion_preliminar->ruta_principal_4}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$proyeccion_preliminar->ruta_principal_5}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$proyeccion_preliminar->ruta_principal_6}}"  required autocomplete="off" autofocus 
                                                            >
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$transporte_proyeccion->cant_transporte_rp}}" required autocomplete="off" autofocus  >
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        value="{{$transporte_proyeccion->docen_respo_trasnporte_rp}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-12" id="transporte_rp">
                                        <div class="row" id="transporte_rp_children">
                                            ...
                                            <div class="col-md-2">
                                                <label for="capac_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                                <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                value="{{$transporte_proyeccion->capac_transporte_rp_2}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-12" id="transporte_rp">
                                        <div class="row" id="transporte_rp_children">
                                            ...
                                            <div class="col-md-2">
                                                <label for="capac_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                                <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                value="{{$transporte_proyeccion->capac_transporte_rp_3}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($proyeccion_preliminar->conf_curricul_plan_pract_rp == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$proyeccion_preliminar->cantidad_url_ra}}" autocomplete="off" autofocus required  >
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$transporte_proyeccion->cant_transporte_ra}}" required autocomplete="off" autofocus  > 
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        value="{{$transporte_proyeccion->docen_respo_trasnporte_ra}}" required autocomplete="off" autofocus >
                            ...
                            <!-- 14 transporte_ra_2 -->
                                <div class="form-group row" id="transporte_ra_2_edit">
                                    ...
                                    <div class="col-md-2">
                                        <label for="capac_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                        <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                        value="{{$transporte_proyeccion->capac_transporte_ra_2}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="det_tipo_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                        <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                        value="{{$transporte_proyeccion->det_tipo_transporte_ra_2}}" required autocomplete="off" autofocus >
                            ...
                            <!-- 14 transporte_ra_3 -->
                                <div class="form-group row" id="transporte_ra_3_edit">
                                    ...
                                    <div class="col-md-2">
                                        <label for="capac_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                        <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                        value="{{$transporte_proyeccion->capac_transporte_ra_3}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="det_tipo_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                        <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                        value="{{$transporte_proyeccion->det_tipo_transporte_ra_3}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($proyeccion_preliminar->conf_curricul_plan_pract_ra == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <!-- valor estimado transporte -->
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    value="{{ number_format($costos_proyeccion->valor_estimado_transporte_rp,'0',',','.')}}" required autocomplete="off" autofocus >
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ number_format($costos_proyeccion->valor_estimado_transporte_ra,'0',',','.')}}" required autocomplete="off" autofocus >
                        ...
                        @if($proyeccion_preliminar->aprobacion_coordinador == 7)
                            <br>
                            <h4>Observaciones</h4>
                            <hr class="divider">
                            <br>
                                ...
                                <!-- 20 -->
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            title="" autocomplete="off" autofocus readonly><?php echo $proyeccion_preliminar->observ_decano?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <?php if($proyeccion_preliminar->aprobacion_consejo_facultad == 3) echo ''?>>
                                                            @if($proyeccion_preliminar->aprobacion_decano == 5)
                                                            <label class="form-check-label" for="">Pendiente</label>
                                                            @elseif($proyeccion_preliminar->aprobacion_decano == 7)
                                                            <label class="form-check-label" for="">Visto Bueno</label>
                                                            @elseif($proyeccion_preliminar->aprobacion_decano == 4)
