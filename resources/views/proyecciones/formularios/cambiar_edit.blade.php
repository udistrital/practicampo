        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('proy_cambios',Crypt::encrypt($proyeccion_preliminar->id)) }}" id="edit_proyeccion">
                            {{-- @method('PUT') --}}
                            @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_programa_academico" id="cambiar_programa_academico" value="0" 
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_programa_academico == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Programa Académico</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_espacio_academico" id="cambiar_espacio_academico"  value="0"
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_espacio_academico == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Espacio Académico</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_sem_anio_per" id="cambiar_sem_anio_per"  value="0"
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_sem_anio_per == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Sem. Año - Per.</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_integrada" id="cambiar_integrada"  value="0"
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_integrada == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Práctica Integrada</label>
                                                        </div>
                                                    </div>        
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_estudiantes" id="cambiar_estudiantes" value="0" 
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_estudiantes == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Estudiantes</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_grupos" id="cambiar_grupos"  value="0"
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_grupos == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Cant. Grupos</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="cambiar_personal_apoyo" id="cambiar_personal_apoyo"  value="0"
                                                            title=""
                                                            <?php if($cambios_proyeccion->cambiar_personal_apoyo == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Personal Apoyo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_destino_rp" id="cambiar_destino_rp" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_destino_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Destino</label>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_url_rp" id="cambiar_url_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_url_rp == 1) echo 'checked'?> >
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_detalle_rp" id="cambiar_detalle_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_detalle_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Detalle Recorrido</label>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_sedes_rp" id="cambiar_sedes_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_sedes_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Sedes</label>
                                                    </div>
                                                </div>        
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_fechas_rp" id="cambiar_fechas_rp" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_fechas_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Fechas</label>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_transporte_rp" id="cambiar_transporte_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_transporte_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Transporte</label>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_transporte_menor_rp" id="cambiar_transporte_menor_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_transporte_menor_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Transporte Menor - Local</label>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_otros_rp" id="cambiar_otros_rp"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_otros_rp == 1) echo 'checked'?> >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_actividades_riesgo_rp" id="cambiar_actividades_riesgo_rp" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_actividades_riesgo_rp == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Actividades de Riesgo</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- 6 -->
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <select id="lugar_salida_rp" name="lugar_regreso_ra" class="form-control" required disabled
                                                    title="" >
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <select id="lugar_salida_rp" name="lugar_regreso_rp" class="form-control" required disabled
                                                    title="" >
                                                    @foreach($sedes as $sede)
                                    ...
                                    <div  class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{$transporte_proyeccion->cant_transporte_rp}}" required autocomplete="off" autofocus disabled readonly>
                                ...
                                <!-- cant t. menor -->
                                    <div  class="form-group row">
                                        ...
                                        <div class="col-md-5" id="docente_trans_menor_rp">
                                            ...
                                            title=""
                                            value="{{ $transporte_menor->docente_resp_t_menor_rp }}" required autocomplete="off" autofocus readonly>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group" style="margin-right: 15px;">
                                                <label class="switch">
                                                    ...
                                                    <?php if($proyeccion_preliminar->conf_curricul_plan_pract_rp == 1) echo 'checked'?> disabled>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_destino_ra" id="cambiar_destino_ra" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_destino_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Destino</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_url_ra" id="cambiar_url_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_url_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">URL</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_detalle_ra" id="cambiar_detalle_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_detalle_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Detalle Recorrido</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_sedes_ra" id="cambiar_sedes_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_sedes_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Sedes</label>
                                                    </div>
                                                </div>        
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_fechas_ra" id="cambiar_fechas_ra" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_fechas_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Fechas</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_transporte_ra" id="cambiar_transporte_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_transporte_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Transporte</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_transporte_menor_ra" id="cambiar_transporte_menor_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_transporte_menor_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Transporte Menor - Local</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_otros_ra" id="cambiar_otros_ra"  value="0"
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_otros_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Otros</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="cambiar_actividades_riesgo_ra" id="cambiar_actividades_riesgo_ra" value="0" 
                                                        title=""
                                                        <?php if($proyeccion_preliminar->cambiar_actividades_riesgo_ra == 1) echo 'checked'?> >
                                                        <label class="form-check-label" for="">Actividades de Riesgo</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div  class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{$transporte_proyeccion->cant_transporte_ra}}" required autocomplete="off" autofocus disabled readonly> 
                                ...
                                <!-- cant t. menor -->
                                    <div  class="form-group row">
                                        ...
                                        <div class="col-md-5" id="docente_trans_menor_ra">
                                            ...
                                            title=""
                                            value="{{ $transporte_menor->docente_resp_t_menor_ra }}" required autocomplete="off" autofocus readonly>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group" style="margin-right: 15px;">
                                                <label class="switch">
                                                    ...
                                                    <?php if($proyeccion_preliminar->conf_curricul_plan_pract_ra == 1) echo 'checked'?> disabled>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-5 offset-md-5">
                                    <br>
                                    <button type="submit" class="btn btn-success" id="edit_proy" name="edit_proy" >
                                        {{ __('Habilitar') }}
                                        {{-- onclick="valid_edit_proy()" --}}
                                    </button>
                                </div>
                            </div>
                            <!-- 25 -->
