...
@if($proyeccion_preliminar->aprobacion_coordinador == 4)
<br>
<h4>Observaciones</h4>
<hr class="divider">
<br>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php if($proyeccion_preliminar->aprobacion_decano == 5) echo 'checked'?> disabled>
                            <label class="form-check-label" for="">Pendiente</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php if($proyeccion_preliminar->aprobacion_decano == 3) echo 'checked'?>  disabled>
                            <label class="form-check-label" for="">Aprobado</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-check form-check-inline">
                                ...
                                <?php if($proyeccion_preliminar->aprobacion_decano == 4) echo 'checked'?> disabled>
                                <label class="form-check-label" for="">Rechazado</label>
                            </div>
                        </div>
