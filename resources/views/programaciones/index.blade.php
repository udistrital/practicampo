    ...
    @if(Auth::user()->admin() || Auth::user()->decano() || Auth::user()->coordinador() || Auth::user()->asistenteD())
      <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
              @include('programaciones.buscador')
        </div>
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
          <form method="POST" action="{{ route('import_list_proyecc.excel') }}"  enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group">
                    <input type="file"  name="programaciones_preliminares" class="form-control" required style="color: rgb(243, 3, 3)">
              </div>
              <div class="form-group">
                <label for=""></label>
                  <button class="btn btn-success" name="import_programaciones" title="Importar Archivo Excel"><i class="fas fa-file-import"></i>     SUBIR</button>
              </div>
            </div> 
          </form>
        </div>
          ...
          {{-- <table class="table table-bordered table-condensed table-hover table-sm" cellspacing="0" style="table-layout: fixed; width:100%; word-break: break-word; font-size: 12px"> --}}
            {{-- <form name="proy_buscador"> --}}
              ...
              <div class="row" >
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="id_filtro_programacion"   @if(!isset($filter)) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="1" checked>
                            ...
                            @if(Auth::user()->admin())
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'inact')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="16">
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'not_send_docente')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="15">
                            ...
                            @if(!Auth::user()->decano() && !Auth::user()->admin())
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'send')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="2">
                            ...
                            @if(Auth::user()->coordinador() || Auth::user()->decano() || Auth::user()->asistenteD())
                              ...
                              @if(Auth::user()->coordinador())
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'pend')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="7">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'proy_recha_cons')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="18">
                              ...
                              @if(Auth::user()->decano())
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'aprob')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="9">
                                ...
                                {{-- <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'elect')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="6">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'aprob-cons')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="11">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'edit_proy')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="17">
                                      <label class="form-check-label" for="">Editar Programación</label>
                                  </div>
                                </div>
                              @endif
                              ...
                              @if(Auth::user()->asistenteD())
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'no-aprob-cons')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="12">
                            ...
                            @if(Auth::user()->docente())
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="id_filtro_programacion"  @if(isset($filter) and ($filter == 'proy_recha')) checked="true" @endif onclick="filtrar_programaciones(this.value)" value="14">
              ...
              @if(Auth::user()->admin())
                @include('programaciones.tablas.index_admin',$programaciones)
              @endif  

              @if(Auth::user()->decano())
                @include('programaciones.tablas.index_dec',$programaciones)
              @endif 

              @if(Auth::user()->asistenteD())
                @include('programaciones.tablas.index_asisDec',$programaciones)
              @endif 

              @if(Auth::user()->coordinador())
                @include('programaciones.tablas.index_coord',$programaciones)
              @endif 

              @if(Auth::user()->docente())
                @include('programaciones.tablas.index_docen',$programaciones)
              @endif
            {{-- </form> --}}
          <br>
    </div>
