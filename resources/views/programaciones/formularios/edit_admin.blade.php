                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <?php if($programacion_practica->aprobacion_coordinador == 5) echo 'checked'?>  >
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-check form-check-inline">
                                    ...
                                    <?php if($programacion_practica->aprobacion_coordinador == 4) echo 'checked'?>  >
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <?php if($programacion_practica->aprobacion_decano == 5) echo 'checked'?>
                                {{-- <php if($programacion_practica->aprobacion_consejo_facultad == 3) echo 'disabled'?> --}}
                                    >
                                <label class="form-check-label" for="">Pendiente</label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <?php if($programacion_practica->aprobacion_decano == 7) echo 'checked'?>
                                {{-- <php if($programacion_practica->aprobacion_consejo_facultad == 3) echo 'disabled'?> --}}
                                    >
                                <label class="form-check-label" for="">Visto Bueno</label>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-check form-check-inline">
                                    ...
                                    <?php if($programacion_practica->aprobacion_decano == 4) echo 'checked'?>
                                    {{-- <php if($programacion_practica->aprobacion_consejo_facultad == 3) echo 'disabled'?> --}}
                                        >
                                    <label class="form-check-label" for="">Rechazado</label>
                                </div>
        ...
        <!-- estado Consejo Facultad-->
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    ...
                    value="{{$programacion_practica->num_acta_consejo_facultad}}" pattern="^[0-9]+"  autocomplete="off" autofocus >
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        value="{{$programacion_practica->fecha_acta_consejo_facultad}}">
                        </div>
                </div>
            </div>
        <!-- 0 -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <?php if($programacion_practica->id_estado == 1) echo 'checked'?> onclick="obsInactProy(this)">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <?php if($programacion_practica->id_estado == 2) echo 'checked'?> onclick="obsInactProy(this)">
                    ...
                    <!-- 2 -->
                        <div class="col-md-12" id="div_obs_inact_proy">
                            ...
                            <textarea id="obs_inact_proy" style="min-height:5rem;" type="text" class="form-control @error('obs_inact_proy') is-invalid @enderror" name="obs_inact_proy" 
                             autocomplete="off" autofocus ><?php echo $programacion_practica->observ_inactividad?></textarea>
