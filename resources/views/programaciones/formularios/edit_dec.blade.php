                        ...
                        <div class="col-md-12" style="padding-left: 0;">
                            <div class="input-group">
                                <div class="col-md-5" style="padding-left: 0px;padding-right: 0px;">
                                    ...
                                    value="{{$programacion_practica->anio_periodo}}" autocomplete="off" autofocus required readonly>
                                </div>
    ...
    <!-- 2 -->
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                title=""
                value="{{$programacion_practica->num_estudiantes_aprox}}" required autocomplete="off" autofocus readonly>
    ...
    <!-- 6 -->
        <div class="form-group row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                value="{{$programacion_practica->fecha_salida_aprox_rp}}" readonly disabled>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                value="{{$programacion_practica->fecha_regreso_aprox_rp}}" readonly disabled>
                </div>
            </div>
        ...
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                <div class="input-group">
                    ...
                    value="{{$transporte_programacion->cant_transporte_rp}}" required autocomplete="off" autofocus disabled readonly>
            ...
            <div class="col-md-12" id="transporte_rp">
                <div class="row" id="transporte_rp_children">
                    ...
                    <div class="col-md-2">
                        ...
                        value="{{$transporte_programacion->capac_transporte_rp_1}}"  autocomplete="off" autofocus readonly>
    ...
    <!-- materiales -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                value="{{$mater_herra_programacion->det_materiales_rp}}" autocomplete="off" autofocus disabled>
    ...
    <!-- guías -baquianos -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_programacion->det_guias_baquianos_rp}}" autocomplete="off" autofocus disabled>
    ...
    <!-- otros - boletas -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                title=""
                value="{{$mater_herra_programacion->det_otros_boletas_rp}}" autocomplete="off" autofocus disabled>
            ...
            <div class="col-md-1">
                <div class="form-group" style="margin-right: 15px;">
                    <label class="switch">
                        ...
                        <?php if($programacion_practica->conf_curricul_plan_pract_rp == 1) echo 'checked'?> disabled>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                ...
                <div class="input-group">
                    ...
                    title=""
                    value="{{$programacion_practica->cantidad_url_ra}}" autocomplete="off" autofocus required readonly disabled>
    ...
    <!-- 12 -->
        <div class="form-group row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                value="{{$programacion_practica->fecha_salida_aprox_ra}}" readonly disabled>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                value="{{$programacion_practica->fecha_regreso_aprox_ra}}" readonly disabled>
                </div>
            </div>
        ...
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                <div class="input-group">
                    ...
                    value="{{$transporte_programacion->cant_transporte_ra}}" required autocomplete="off" autofocus disabled readonly> 
    ...
    <!-- 14 transporte_ra_1 -->
        <div class="form-group row" id="transporte_ra_1_edit">
            ...
            <div class="col-md-2">
                ...
                value="{{$transporte_programacion->capac_transporte_ra_1}}"  autocomplete="off" autofocus readonly>
    ...
    <!-- materiales -->
        <div class="form-group row">
            <div class="col-md-8">
                ...
                value="{{$mater_herra_programacion->det_materiales_ra}}" autocomplete="off" autofocus disabled>
            ...
            <div class="col-md-1">
                <div class="form-group" style="margin-right: 15px;">
                    <label class="switch">
                        ...
                        <?php if($programacion_practica->conf_curricul_plan_pract_ra == 1) echo 'checked'?> disabled>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
...
<!-- valor estimado transporte -->
    <div class="form-group row">
        <div class="col-md-6">
            ...
            value="{{ number_format($costos_programacion->valor_estimado_transporte_rp,'0',',','.')}}" required autocomplete="off" autofocus readonly>
        ...
        <div class="col-md-6">
            ...
            value="{{ number_format($costos_programacion->valor_estimado_transporte_ra,'0',',','.')}}" required autocomplete="off" autofocus readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <?php if($programacion_practica->aprobacion_coordinador == 7) echo 'checked'?>  disabled>
        ...
        <!-- 20 -->
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    title="" autocomplete="off" autofocus><?php echo $programacion_practica->observ_decano?></textarea>
