                ...
                <div class="card">
                    ...
                    <div class="row">                        
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="habilitar_cambios">{{ __('Habilitar Cambios') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-5">
                                <label class="switch">
                                    <input type="checkbox" name="habilitar_cambios" id="habilitar_cambios" onchange="habilitar_inputs_cambios('cambios_programacion')" value="0">
                     ...
                     Habilitar cambios -->
                    <form method="POST" action="{{ route('proy_cambios',Crypt::encrypt($programacion_practica->id)) }}" id="cambios_programacion">
                    @method('PUT')
                    @csrf  
                        @if($programacion_practica->aprobacion_consejo_facultad == 3 ||  $estado_doc_respon == 2)
                        <!-- información docente -->   
                            <!-- 1 -->
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select name="docentes_activos" class="form-control" required >
                                            @foreach($docentes_activos as $doc_act)
                                                <option <?php if($doc_act->id==$programacion_practica->id_docente_responsable) echo 'selected'?> 
                                                    value="{{$doc_act->id}}">{{$doc_act->primer_nombre}} {{$doc_act->segundo_nombre}} {{$doc_act->primer_apellido}} {{$doc_act->segundo_apellido}}</option>  
                                            @endforeach
                                        </select>
                            ...
                            <!-- 1 -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <select id="id_semestre_asignatura" name="id_semestre_asignatura" class="form-control" required  style="padding-left: 0.1rem;padding-right: 0.1rem;">
                                                ...
                                                <div class="col-md-12" style="padding-left: 0;">
                                                    <div class="input-group">
                                                        <div class="col-md-5" style="padding-left: 0px;padding-right: 0px;">
                                                            ...
                                                            value="{{$programacion_practica->anio_periodo}}" autocomplete="off" autofocus required >
                                                        </div>
                                ...
                                <div  class="form-group row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    title=""
                                                    <?php if($programacion_practica->practicas_integradas == 1) echo 'checked'?> >
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        title=""
                                                        <?php if($programacion_practica->practicas_integradas == 0) echo 'checked'?> >
                                    ...
                                    <div class="col-md-2" id="c_espa_aca">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$practicas_integradas->cant_espa_aca}}" autocomplete="off" autofocus onchange=""  >
                                    ...
                                    <!-- viaticos -->
                                        <div class="col-md-1" style="height: 1rem;">
                                            ...
                                            value={{$vlr_viaticos->vlr_estud_max_estimado}} autocomplete="off" autofocus  style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                            <input id="vlr_estud_min" type="text"  class="form-control @error('vlr_estud_min') is-invalid @enderror" name="vlr_estud_min" 
                                            value={{$vlr_viaticos->vlr_estud_min_estimado}} autocomplete="off" autofocus  style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                        {{-- </div> 

                                        <div class="col-md-1"> --}}
                                            <input id="vlr_docen_max" type="text"  class="form-control @error('vlr_docen_max') is-invalid @enderror" name="vlr_docen_max" 
                                            value={{$vlr_viaticos->vlr_docen_max_estimado}} autocomplete="off" autofocus  style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                            <input id="vlr_docen_min" type="text"  class="form-control @error('vlr_docen_min') is-invalid @enderror" name="vlr_docen_min" 
                                            value={{$vlr_viaticos->vlr_docen_min_estimado}} autocomplete="off" autofocus  style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                        {{-- </div>

                                        <div class="col-md-1"> --}}
                                            <input id="pregrado" type="text"  class="form-control @error('pregrado') is-invalid @enderror" name="pregrado" 
                                            value="" autocomplete="off" autofocus  style="background-color:transparent; border-color:transparent; color:transparent !important">
                                ...
                                <div  class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title="" 
                                            value="{{$programacion_practica->cantidad_grupos}}" autocomplete="off" autofocus >
                                            @error('cant_grupos')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$docentes_practica->num_docentes_apoyo}}" autocomplete="off" autofocus >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            title="" 
                                            <?php if($programacion_practica->realizada_bogota_rp == 1) echo 'checked'?>>
                                            <label class="form-check-label" for="">Si</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-check form-check-inline">
                                                ...
                                                title="" 
                                                <?php if($programacion_practica->realizada_bogota_rp == 0) echo 'checked'?>>
                                                <label class="form-check-label" for="">No</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- ruta principal -->
                            <!-- 3 -->
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        value="{{$programacion_practica->destino_rp}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$programacion_practica->cantidad_url_rp}}" autocomplete="off" autofocus  >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal_2}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal_3}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal_4}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal_5}}"  required autocomplete="off" autofocus 
                                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_principal_6}}"  required autocomplete="off" autofocus 
                                                            >
                            ...
                            <!-- 5 -->
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        required autocomplete="off" autofocus ><?php echo $programacion_practica->det_recorrido_interno_rp?></textarea>
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$transporte_programacion->cant_transporte_rp}}" required autocomplete="off" autofocus  >
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        value="{{$transporte_programacion->docen_respo_trasnporte_rp}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-12" id="transporte_rp">
                                        <div class="row" id="transporte_rp_children">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                value="{{$transporte_programacion->capac_transporte_rp_1}}"  autocomplete="off" autofocus >
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                value="{{$transporte_programacion->det_tipo_transporte_rp_1}}" autocomplete="off" autofocus >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <?php if($transporte_programacion->exclusiv_tiempo_rp_1 == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Si</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <?php if($transporte_programacion->exclusiv_tiempo_rp_1 == 0) echo 'checked'?> >
                                                                <label class="form-check-label" for="">No</label>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-md-12" id="transporte_rp">
                                        <div class="row" id="transporte_rp_children">
                                            ...
                                            <div class="col-md-2">
                                                <label for="capac_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                                <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                value="{{$transporte_programacion->capac_transporte_rp_2}}" required autocomplete="off" autofocus >
                                            ...
                                            <div class="col-md-4">
                                                <label for="det_tipo_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                                <input id="det_tipo_transporte_rp_[]" type="text" class="form-control @error('det_tipo_transporte_rp_[]') is-invalid @enderror" name="det_tipo_transporte_rp_[]" 
                                                value="{{$transporte_programacion->det_tipo_transporte_rp_2}}" autocomplete="off" autofocus >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <?php if($transporte_programacion->exclusiv_tiempo_rp_2 == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Si</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <?php if($transporte_programacion->exclusiv_tiempo_rp_2 == 0) echo 'checked'?> >
                                                                <label class="form-check-label" for="">No</label>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-md-12" id="transporte_rp">
                                        <div class="row" id="transporte_rp_children">
                                            ...
                                            <div class="col-md-2">
                                                <label for="capac_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                                <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                value="{{$transporte_programacion->capac_transporte_rp_3}}" required autocomplete="off" autofocus >
                                            ...
                                            <div class="col-md-4">
                                                <label for="det_tipo_transporte_rp_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                                <input id="det_tipo_transporte_rp_[]" type="text" class="form-control @error('det_tipo_transporte_rp_[]') is-invalid @enderror" name="det_tipo_transporte_rp_[]" 
                                                value="{{$transporte_programacion->det_tipo_transporte_rp_3}}" autocomplete="off" autofocus >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <?php if($transporte_programacion->exclusiv_tiempo_rp_3 == 1) echo 'checked'?> >
                                                            <label class="form-check-label" for="">Si</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <?php if($transporte_programacion->exclusiv_tiempo_rp_3 == 0) echo 'checked'?> >
                                                                <label class="form-check-label" for="">No</label>
                                                            </div>
                                                        </div>
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$transporte_menor->cant_trans_menor_rp}}" required autocomplete="off" autofocus  >
                                    ...
                                    <div class="col-md-5" id="docente_trans_menor_rp">
                                        ...
                                        title=""
                                        value="{{ $transporte_menor->docente_resp_t_menor_rp }}" required autocomplete="off" autofocus >
                            ...
                            <!-- materiales -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        value="{{$mater_herra_programacion->det_materiales_rp}}" autocomplete="off" autofocus >
                            ...
                            <!-- guías -baquianos -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <label for="det_guias_baquia_rp" class="col-form-label text-md-left" title="">{{ __('Guías y/o Baquianos') }}</label>
                                        ...
                                        title=""
                                        value="{{$mater_herra_programacion->det_guias_baquianos_rp}}" autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="vlr_guias_baquia_rp" class="col-form-label text-md-left" title="">{{ __('Valor Total Guías y/o Baquianos') }}</label>
                                        {{-- <span class="hs-form-required">*</span> --}}
                                        ...
                                        title="" 
                                        value="{{number_format($costos_programacion->vlr_guias_baquianos_rp,'0',',','.')}}" autocomplete="off" autofocus onkeyup="formatVlr(this)" onchange="formatVlr(this)">
                            ...
                            <!-- otros - boletas -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        title=""
                                        value="{{$mater_herra_programacion->det_otros_boletas_rp}}" autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="vlr_otros_bolet_rp" class="col-form-label text-md-left" title="">{{ __('Valor Total Boletas y/u Otros') }}</label>
                                        {{-- <span class="hs-form-required">*</span> --}}
                                        ...
                                        title="" 
                                        value="{{number_format($costos_programacion->vlr_otros_boletas_rp,'0',',','.')}}" autocomplete="off" autofocus onkeyup="formatVlr(this)" onchange="formatVlr(this)">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($programacion_practica->conf_curricul_plan_pract_rp == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            title="" 
                                            <?php if($programacion_practica->realizada_bogota_ra == 1) echo 'checked'?>>
                                            <label class="form-check-label" for="">Si</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-check form-check-inline">
                                                ...
                                                title="" 
                                                <?php if($programacion_practica->realizada_bogota_ra == 0) echo 'checked'?>>
                                                <label class="form-check-label" for="">No</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- 9 -->
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        value="{{$programacion_practica->destino_ra}}" required autocomplete="off" autofocus >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            value="{{$programacion_practica->ruta_alterna}}"  required autocomplete="off" autofocus >
                            ...
                            <!-- 11 -->
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        required autocomplete="off" autofocus ><?php echo $programacion_practica->det_recorrido_interno_ra?></textarea>
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$transporte_programacion->cant_transporte_ra}}" required autocomplete="off" autofocus  > 
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input id="docente_resp_transp_ra" type="text" class="form-control @error('docente_resp_transp_ra_') is-invalid @enderror" name="docente_resp_transp_ra" 
                                        value="{{$transporte_programacion->docen_respo_trasnporte_ra}}" required autocomplete="off" autofocus >
                            ...
                            <!-- 14 transporte_ra_1 -->
                                <div class="form-group row" id="transporte_ra_1_edit">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        value="{{$transporte_programacion->capac_transporte_ra_1}}"  autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        value="{{$transporte_programacion->det_tipo_transporte_ra_1}}" autocomplete="off" autofocus >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <?php if($transporte_programacion->exclusiv_tiempo_ra_1 == 1) echo 'checked'?> >
                                                    <label class="form-check-label" for="">Si</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <?php if($transporte_programacion->exclusiv_tiempo_ra_1 == 0) echo 'checked'?> >
                                                        <label class="form-check-label" for="">No</label>
                                                    </div>
                                                </div>
                            ...
                            <!-- 14 transporte_ra_2 -->
                                <div class="form-group row" id="transporte_ra_2_edit">
                                    ...
                                    <div class="col-md-2">
                                        <label for="capac_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                        <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                        value="{{$transporte_programacion->capac_transporte_ra_2}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="det_tipo_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                        <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                        value="{{$transporte_programacion->det_tipo_transporte_ra_2}}" required autocomplete="off" autofocus >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <?php if($transporte_programacion->exclusiv_tiempo_ra_2 == 1) echo 'checked'?> >
                                                    <label class="form-check-label" for="">Si</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <?php if($transporte_programacion->exclusiv_tiempo_ra_2 == 0) echo 'checked'?> >
                                                        <label class="form-check-label" for="">No</label>
                                                    </div>
                                                </div>
                            ...
                            <!-- 14 transporte_ra_3 -->
                                <div class="form-group row" id="transporte_ra_3_edit">
                                    ...
                                    <div class="col-md-2">
                                        <label for="capac_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Cap. Vehíc.') }}</label>
                                        <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                        value="{{$transporte_programacion->capac_transporte_ra_3}}" required autocomplete="off" autofocus >
                                    ...
                                    <div class="col-md-4">
                                        <label for="det_tipo_transporte_ra_[]" class="col-form-label text-md-left">{{ __('Det. Vehíc.') }}</label>
                                        <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                        value="{{$transporte_programacion->det_tipo_transporte_ra_3}}" required autocomplete="off" autofocus >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <?php if($transporte_programacion->exclusiv_tiempo_ra_3 == 1) echo 'checked'?> >
                                                    <label class="form-check-label" for="">Si</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <?php if($transporte_programacion->exclusiv_tiempo_ra_3 == 0) echo 'checked'?> >
                                                        <label class="form-check-label" for="">No</label>
                                                    </div>
                                                </div>
                                ...
                                <div  class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            title=""
                                            value="{{$transporte_menor->cant_trans_menor_ra}}" required autocomplete="off" autofocus  >
                                    ...
                                    <div class="col-md-5" id="docente_trans_menor_ra">
                                        ...
                                        title=""
                                        value="{{ $transporte_menor->docente_resp_t_menor_ra }}" required autocomplete="off" autofocus >
                            ...
                            <!-- materiales -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        value="{{$mater_herra_programacion->det_materiales_ra}}" autocomplete="off" autofocus >
                            ...
                            <!-- guías -baquianos -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        title="" 
                                        value="{{$mater_herra_programacion->det_guias_baquianos_ra}}" autocomplete="off" autofocus>
                            ...
                            <!-- otros - boletas -->
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        title="" 
                                        value="{{$mater_herra_programacion->det_otros_boletas_ra}}" autocomplete="off" autofocus>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($riesg_amen_practica->riesgo_biologico_ra == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($riesg_amen_practica->espacios_confinados_ra == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group" style="margin-right: 15px;">
                                            <label class="switch">
                                                ...
                                                <?php if($programacion_practica->conf_curricul_plan_pract_ra == 1) echo 'checked'?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <!-- valor estimado transporte -->
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="vlr_est_transp_rp" class="col-form-label text-md-left">{{ __('Valor Estimado Transporte Ruta Principal') }}</label>
                                    <span class="hs-form-required">*</span>
                                    ...
                                    value="{{ number_format($costos_programacion->valor_estimado_transporte_rp,'0',',','.')}}" required autocomplete="off" autofocus >
                                ...
                                <div class="col-md-6">
                                    <label for="vlr_est_transp_ra" class="col-form-label text-md-left">{{ __('Valor Estimado Transporte Ruta Contingencia') }}</label>
                                    <span class="hs-form-required">*</span>
                                    ...
                                    value="{{ number_format($costos_programacion->valor_estimado_transporte_ra,'0',',','.')}}" required autocomplete="off" autofocus >
                                ...
                                <!-- 18 -->
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            autocomplete="off" autofocus readonly><?php echo $programacion_practica->observ_coordinador?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <?php if($programacion_practica->aprobacion_coordinador == 7) echo 'checked'?>  >
                                ...
                                <!-- 20 -->
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            title="" autocomplete="off" autofocus readonly><?php echo $programacion_practica->observ_decano?></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="aprobacion_decano" value="0" checked
                                                            <?php if($programacion_practica->aprobacion_consejo_facultad == 3) echo ''?>>
                                                            @if($programacion_practica->aprobacion_decano == 5)
                                                            <label class="form-check-label" for="">Pendiente</label>
                                                            @elseif($programacion_practica->aprobacion_decano == 7)
                                                            <label class="form-check-label" for="">Visto Bueno</label>
                                                            @elseif($programacion_practica->aprobacion_decano == 4)
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="estado_programacion" value="1" 
                                                            <?php if($programacion_practica->id_estado == 1) echo 'checked'?>>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="estado_programacion" value="2" 
                                                            <?php if($programacion_practica->id_estado == 2) echo 'checked'?>>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-5 offset-md-5">
                            <br>
                            <button type="submit" class="btn btn-success" id="edit_proy" name="edit_proy" onclick="">
                                {{ __('Guardar') }}
                            </button>
                        </div>
                    </div>
