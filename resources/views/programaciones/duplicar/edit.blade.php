    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header" id="num_docen" name="{{$programacion_practica->id_docente_responsable}}">{{ __('Duplicar Programación  N° ') }}<?php echo $programacion_practica->id?><?php echo "\t - "?>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('programacion_store') }}" id="edit_programacion" enctype="multipart/form-data" onsubmit="return validar_realizada_bogota() && confirmarGuardar(event)"
                                ...
                                <!-- 1 -->
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            title=""  onchange="recargarEspa_aca_edit(this.value,'<?php echo $programacion_practica->id_espacio_academico?>','<?php echo $programacion_practica->id_docente_responsable?>',1)">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 0;">
                                                        <div class="input-group">
                                                            <div class="col-md-4">
                                                                <select name="id_semestre_asignatura" class="form-control" required style="padding-left: 0.1rem;padding-right: 0.1rem;"
                                                                title="">
                                                            ...
                                                            <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
                                                                <input id="anio_periodo" type="text" maxlength="4" class="inputDate form-control @error('anio_periodo') is-invalid @enderror" name="anio_periodo" 
                                ...
                                <!-- Integradas -->
                                    <div  class="form-group row">
                                        ...
                                        <div class="col-md-1" style="height: 1rem;">
                                            ...
                                            value={{$vlr_viaticos->vlr_estud_max_estimado}} autocomplete="off" autofocus readonly style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                            <input id="vlr_estud_min" type="text"  class="form-control @error('vlr_estud_min') is-invalid @enderror" name="vlr_estud_min" 
                                            value={{$vlr_viaticos->vlr_estud_min_estimado}} autocomplete="off" autofocus readonly style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                        {{-- </div> 

                                        <div class="col-md-1"> --}}
                                            <input id="vlr_docen_max" type="text"  class="form-control @error('vlr_docen_max') is-invalid @enderror" name="vlr_docen_max" 
                                            value={{$vlr_viaticos->vlr_docen_max_estimado}} autocomplete="off" autofocus readonly style="background-color:transparent; border-color:transparent; color:transparent !important">
                                            
                                            <input id="vlr_docen_min" type="text"  class="form-control @error('vlr_docen_min') is-invalid @enderror" name="vlr_docen_min" 
                                            value={{$vlr_viaticos->vlr_docen_min_estimado}} autocomplete="off" autofocus readonly style="background-color:transparent; border-color:transparent; color:transparent !important">
                                        ...
                                        <!-- Cant. URL -->
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    title=""
                                                    value="{{$programacion_practica->cantidad_url_rp}}" autocomplete="off" autofocus readonly>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal}}" autocomplete="off" autofocus
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal_2}}" autocomplete="off" autofocus
                                                                onchange="verifUrl_rp(this)">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal_3}}"  autocomplete="off" autofocus
                                                                onchange="verifUrl_rp(this)">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal_4}}" autocomplete="off" autofocus
                                                                onchange="verifUrl_rp(this)">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal_5}}" autocomplete="off" autofocus
                                                                onchange="verifUrl_rp(this)">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0;">
                                                            <div class="input-group">
                                                                ...
                                                                value="{{$programacion_practica->ruta_principal_6}}" autocomplete="off" autofocus
                                                                onchange="verifUrl_rp(this)">
                                    ...
                                    <div  class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                title=""
                                                value="{{$transporte_programacion->cant_transporte_rp}}" required autocomplete="off" autofocus readonly>
                                        ...
                                        <div class="col-md-12" id="transporte_rp">
                                            <div class="row" id="transporte_rp_children">
                                                ...
                                                <div class="col-md-2" id="capac_transp_edit_rp_2">
                                                    ...
                                                    <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                    title="" onkeyup="onlyNmb(this)" 
                                                    value="{{$transporte_programacion->capac_transporte_rp_2}}" autocomplete="off" autofocus>
                                        ...
                                        <div class="col-md-12" id="transporte_rp">
                                            <div class="row" id="transporte_rp_children">
                                                ...
                                                <div class="col-md-2" id="capac_transp_edit_rp_3">
                                                    ...
                                                    <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                    title="" onkeyup="onlyNmb(this)" 
                                                    value="{{$transporte_programacion->capac_transporte_rp_3}}" autocomplete="off" autofocus>
                                    ...
                                    <div  class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                title=""
                                                value="{{$transporte_programacion->cant_transporte_ra}}" required autocomplete="off" autofocus readonly>
                                        ...
                                        <div class="col-md-5" id="docente_transp_edit_ra">
                                            ...
                                            title=""
                                            value="{{$transporte_programacion->docen_respo_trasnporte_ra}}" required autocomplete="off" autofocus readonly>
                                ...
                                <!-- 14 transporte_ra_2 -->
                                    <div class="form-group row" id="transporte_ra_2_edit">
                                        ...
                                        <div class="col-md-2" id="capac_transp_edit_ra_2">
                                            ...
                                            <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                            title="" onkeyup="onlyNmb(this)" 
                                            value="{{$transporte_programacion->capac_transporte_ra_2}}" autocomplete="off" autofocus>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            value="{{$transporte_programacion->det_tipo_transporte_ra_2}}" autocomplete="off" autofocus>
                                ...
                                <!-- 14 transporte_ra_3 -->
                                    <div class="form-group row" id="transporte_ra_3_edit">
                                        ...
                                        <div class="col-md-2" id="capac_transp_edit_ra_3">
                                            ...
                                            <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                            title="" onkeyup="onlyNmb(this)" 
                                            value="{{$transporte_programacion->capac_transporte_ra_3}}" autocomplete="off" autofocus>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                            title=""
                                            value="{{$transporte_programacion->det_tipo_transporte_ra_3}}" autocomplete="off" autofocus>
                            ...
                            @if($programacion_practica->aprobacion_coordinador == 4)
                            <br>
                            <h4>Observaciones</h4>
                            <hr class="divider">
                            <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <?php if($programacion_practica->aprobacion_coordinador == 5) echo 'checked'?>  disabled>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <?php if($programacion_practica->aprobacion_coordinador == 3) echo 'checked'?>  disabled>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <?php if($programacion_practica->aprobacion_coordinador == 4) echo 'checked'?>  disabled>
                            ...
                            @if($programacion_practica->aprobacion_decano == 4)
                            <h4>Observaciones</h4>
                            <hr class="divider">
                            <br>
                            <!-- Decano -->
                                <!-- 20 -->
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            title="Observaciones del decano" autocomplete="off" autofocus readonly></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <?php if($programacion_practica->aprobacion_decano == 5) echo 'checked'?> disabled>
                                                        <label class="form-check-label" for="">Pendiente</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <?php if($programacion_practica->aprobacion_decano == 3) echo 'checked'?>  disabled>
                                                        <label class="form-check-label" for="">Aprobado</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <?php if($programacion_practica->aprobacion_decano == 4) echo 'checked'?> disabled>
                                                            <label class="form-check-label" for="">Rechazado</label>
                                                        </div>
                                                    </div>
