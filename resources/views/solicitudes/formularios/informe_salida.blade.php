            ...
            <div class="col-md-10">
                <div class="card">
                    {{-- <div class="card-header">{{ __('Registro Solicitud Práctica N° ') }}<php echo $solicitud_practica->id_programacion_practica?> <php echo "\t -"?> --}}
                        <div class="card-header">{{ __('Informe de Práctica Académica N° ') }}<?php echo $solicitud_practica->id_programacion_practica?>
                        {{ __('') }}</div>
                        {{-- <php if($estado_doc_respon == 1){ echo $nombre_doc_resp;} elseif ($estado_doc_respon == 2){ echo "Usuario Inactivo";}?> --}}
                    
                        <div class="card-body">
                            <form method="POST" action="">
                                {{-- {{ route('solicitud_update',[Crypt::encrypt($programacion_practica->id), Crypt::encrypt($tipo_ruta)]) }} --}}
                                @method('PUT')
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{$programacion_practica->lugar_salida_rp}}" required autocomplete="off" autofocus readonly
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{$programacion_practica->lugar_regreso_rp}}" required autocomplete="off" autofocus readonly 
                                        ...
                                        <div class="col-md-12" id="transporte_rp">
                                            <div class="row" id="transporte_rp_children">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    value="{{$transporte_programacion->otro_tipo_transporte_rp_1}}"  autocomplete="off" autofocus required readonly>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    value="{{$transporte_programacion->vlr_otro_tipo_transporte_rp_1}}"  autocomplete="off" autofocus required  onkeyup="formatVlr(this)" onchange="formatVlr(this)" readonly>
                                        ...
                                        <div class="col-md-12" id="transporte_rp">
                                            <div class="row" id="transporte_rp_children">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    title="Valor del otro tipo de vehículo"
                                                    value="{{$transporte_programacion->vlr_otro_tipo_transporte_rp_2}}"  autocomplete="off" autofocus required  
                                                ...
                                                <div class="col-md-2" id="capac_transp_edit_rp_2">
                                                    ...
                                                    <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                    title="Capacidad requerida del vehículo" onkeyup="onlyNmb(this)" 
                                                    value="{{$transporte_programacion->capac_transporte_rp_2}}" autocomplete="off" autofocus disabled>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="det_tipo_transporte_rp_[]" type="text" class="form-control @error('det_tipo_transporte_rp_[]') is-invalid @enderror" name="det_tipo_transporte_rp_[]" 
                                                    title="Detalle asociado al vehículo"
                                                    value="{{$transporte_programacion->det_tipo_transporte_rp_2}}" autocomplete="off" autofocus disabled>
                                        ...
                                        <div class="col-md-12" id="transporte_rp">
                                            <div class="row" id="transporte_rp_children">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    title="Otro tipo de vehículo"
                                                    value="{{$transporte_programacion->otro_transporte_rp_3}}"  autocomplete="off" autofocus required readonly disabled>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    title="Valor del otro tipo de vehículo"
                                                    value="{{$transporte_programacion->vlr_otro_tipo_transporte_rp_3}}"  autocomplete="off" autofocus required  
                                                    onkeyup="formatVlr(this)" onchange="formatVlr(this)" readonly disabled>
                                                ...
                                                <div class="col-md-2" id="capac_transp_edit_rp_3">
                                                    ...
                                                    <input id="capac_transporte_rp_[]" type="text" class="form-control @error('capac_transporte_rp_[]') is-invalid @enderror" name="capac_transporte_rp_[]" 
                                                    title="Capacidad requerida del vehículo" onkeyup="onlyNmb(this)" 
                                                    value="{{$transporte_programacion->capac_transporte_rp_3}}" autocomplete="off" autofocus disabled>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="det_tipo_transporte_rp_[]" type="text" class="form-control @error('det_tipo_transporte_rp_[]') is-invalid @enderror" name="det_tipo_transporte_rp_[]" 
                                                    title="Detalle asociado al vehículo"
                                                    value="{{$transporte_programacion->det_tipo_transporte_rp_3}}" autocomplete="off" autofocus disabled>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    value="{{$programacion_practica->lugar_salida_ra}}" required autocomplete="off" autofocus disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    value="{{$programacion_practica->lugar_regreso_ra}}" required autocomplete="off" autofocus readonly>
                                    ...
                                    <!-- 14 transporte_ra_1 -->
                                        <div class="form-group row" id="transporte_ra_1_edit">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Otro tipo de vehículo"
                                                value="{{$transporte_programacion->otro_tipo_transporte_ra_1}}"  autocomplete="off" autofocus required readonly disabled>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Valor del otro tipo de vehículo"
                                                value="{{$transporte_programacion->vlr_otro_tipo_transporte_ra_1}}"  autocomplete="off" autofocus required  onkeyup="formatVlr(this)" onchange="formatVlr(this)" 
                                                readonly disabled>
                                            ...
                                            <div class="col-md-2" id="capac_transp_edit_ra_1">
                                                ...
                                                title="Capacidad requerida del vehículo" onkeyup="onlyNmb(this)" 
                                                value="{{$transporte_programacion->capac_transporte_ra_1}}" required autocomplete="off" autofocus disabled>
                                    ...
                                    <!-- 14 transporte_ra_2 -->
                                        <div class="form-group row" id="transporte_ra_2_edit">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Otro tipo de vehículo"
                                                value="{{$transporte_programacion->otro_tipo_transporte_ra_2}}"  autocomplete="off" autofocus required readonly disabled>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Valor del otro tipo de vehículo"
                                                value="{{$transporte_programacion->vlr_otro_tipo_transporte_ra_2}}"  autocomplete="off" autofocus required  onkeyup="formatVlr(this)" onchange="formatVlr(this)" 
                                                readonly disabled>
                                            ...
                                            <div class="col-md-2" id="capac_transp_edit_ra_2">
                                                ...
                                                <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                                title="Capacidad requerida del vehículo" onkeyup="onlyNmb(this)" 
                                                value="{{$transporte_programacion->capac_transporte_ra_2}}" autocomplete="off" autofocus readonly>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                                title="Detalle asociado al vehículo"
                                                value="{{$transporte_programacion->det_tipo_transporte_ra_2}}" autocomplete="off" autofocus readonly>
                                    ...
                                    <!-- 14 transporte_ra_3 -->
                                        <div class="form-group row" id="transporte_ra_3_edit">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Otro tipo de vehículo"
                                                value="{{$transporte_programacion->otro_tipo_transporte_ra_3}}"  autocomplete="off" autofocus required readonly disabled>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                title="Valor del otro tipo de vehículo"
                                                value="{{$transporte_programacion->vlr_otro_tipo_transporte_ra_3}}"  autocomplete="off" autofocus required  onkeyup="formatVlr(this)" onchange="formatVlr(this)" 
                                                readonly disabled>
                                            ...
                                            <div class="col-md-2" id="capac_transp_edit_ra_3">
                                                ...
                                                <input id="capac_transporte_ra_[]" type="text" class="form-control @error('capac_transporte_ra_[]') is-invalid @enderror" name="capac_transporte_ra_[]" 
                                                title="Capacidad requerida del vehículo" onkeyup="onlyNmb(this)" 
                                                value="{{$transporte_programacion->capac_transporte_ra_3}}" autocomplete="off" autofocus disabled>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="det_tipo_transporte_ra_[]" type="text" class="form-control @error('det_tipo_transporte_ra_[]') is-invalid @enderror" name="det_tipo_transporte_ra_[]" 
                                                title="Detalle asociado al vehículo"
                                                value="{{$transporte_programacion->det_tipo_transporte_ra_3}}" autocomplete="off" autofocus readonly>
