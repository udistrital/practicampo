        ...
        <!-- 12 -->
            <div class="form-group row">
                ...
                <div class="col-md-1">
                    ...
                    value="{{$proyeccion_preliminar->duracion_num_dias_ra}}" autocomplete="off" autofocus  >
    ...
    <!-- 20 -->
        <div class="form-group row">
            <div class="col-md-12">
                ...
                name="observ_decano" value=""  autocomplete="off" autofocus><?php echo $proyeccion_preliminar->observ_decano?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                {{-- <php if($proyeccion_preliminar->aprobacion_consejo_facultad == 3)?> --}}
                                >
                                <label class="form-check-label" for="">Pendiente</label>
                                </div>
                            </div>
