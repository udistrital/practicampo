    ...
    <!-- 2 -->
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                value="{{$solicitud_practica->num_estudiantes}}" required autocomplete="off" autofocus>
        ...
        <!-- 12 -->
            <div class="form-group row">
                            ...
                            <div class="col-md-12" style="padding-right: 0;">
                                <div class="input-group">
                                    ...
                                    <div class="col-md-6" style="padding-right: 0px;padding-left: 0px;">
                                        ...
                                        style="border-top-right-radius: 0; border-bottom-right-radius: 0"
                                        value="{{$solicitud_practica->fecha_salida}}" onchange="duracion_edit_RA(this.value)"  > 
                                    </div>
                                    <div class="col-md-5" style="padding-left: 0px;padding-right: 0px;">
                            ...
                            <div class="col-md-12" style="padding-right: 0;">
                                <div class="input-group">
                                    ...
                                    <div class="col-md-6" style="padding-right: 0px;padding-left: 0px;">
                                        ...
                                        style="border-top-right-radius: 0; border-bottom-right-radius: 0"
                                        value="{{$solicitud_practica->fecha_regreso}}" onchange="duracion_edit_RA(this.value)"  > 
                                    </div>
                                    <div class="col-md-5" style="padding-left: 0px;padding-right: 0px;">
                                        ...
                                        style="padding-left: 0.5rem;padding-right: 0rem;border-top-left-radius: 0; border-bottom-left-radius: 0;margin-top: 1px;"
                                        value="{{$solicitud_practica->hora_regreso}}" autocomplete="off" autofocus  >
                                    </div>
                                </div>
                            </div>  
                        </div>
                ...
                <div class="col-md-1">
                    ...
                    value="{{$programacion_practica->duracion_num_dias_ra}}" autocomplete="off" autofocus  >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-check form-check-inline">
                                    ...
                                    title="Sin disponiblidad permanente">
                                    <label class="form-check-label" for="">No</label>
                                </div>
                            </div>
        ...
        <!-- guías -baquianos -->
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    ...
                    title="Valor de los guías y/o baquianos"
        ...
        <!-- otros - boletas -->
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    ...
                    title="Valor de las boletas y/u otros"
...
<!-- cronograma -->
    <div class="form-group row">
        <div class="col-md-12">
            ...
            autocomplete="off" autofocus ><?php echo $solicitud_practica->cronograma?></textarea>
...
<!-- justificacion -->
    <div class="form-group row">
        <div class="col-md-12">
            ...
            autocomplete="off" autofocus ><?php echo $solicitud_practica->justificacion?></textarea>
...
<!-- objetivo_general -->
    <div class="form-group row">
        <div class="col-md-12">
            ...
            autocomplete="off" autofocus ><?php echo $solicitud_practica->objetivo_general?></textarea>
...
<!-- metodologia_evaluacion -->
    <div class="form-group row">
        <div class="col-md-12">
            ...
            autocomplete="off" autofocus ><?php echo $solicitud_practica->metodologia_evaluacion?></textarea>
        ...
        <!-- estado coord-->
            <!-- 0 -->
                <div class="form-group row">
                    ...
                    <div class="form-group">
                        <label for="id_estado"><i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
    ...
    <!-- 20 -->
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <textarea id="observ_decano" style="min-height:5rem;" type="text" class="form-control @error('observ_decano') is-invalid @enderror" 
                name="observ_decano" value=""  autocomplete="off" autofocus><?php echo $programacion_practica->observ_decano?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                {{-- <php if($programacion_practica->aprobacion_consejo_facultad == 3)?> --}}
                                >
                                <label class="form-check-label" for="">Pendiente</label>
                                </div>
                            </div>
