        ...
        <!-- materiales -->
            <div class="form-group row">
                <div class="col-md-8">
                    ...
                    value="{{$mate_herra_programacion->det_materiales_rp}}" autocomplete="off" autofocus readonly>
        ...
        <!-- guías -baquianos -->
            <div class="form-group row">
                <div class="col-md-8">
                    ...
                    value="{{$mate_herra_programacion->det_guias_baquianos_rp}}" autocomplete="off" autofocus disabled>
        ...
        <!-- otros - boletas -->
            <div class="form-group row">
                <div class="col-md-8">
                    ...
                    value="{{$mate_herra_programacion->det_otros_boletas_rp}}" autocomplete="off" autofocus disabled>
...
@if($tipo_ruta == 1)
    <table class="table table-bordered table-condensed table-hover table-sm header_table" cellspacing="0">
        ...
        <tr>
            ...
            <td>{{ number_format($costos_programacion->valor_estimado_transporte_rp, 0, ',','.') }}</td>
            
        </tr>

        <tr>
            <td colspan="4">Total Presupuesto: </td>
            <td>{{ number_format($costos_programacion->viaticos_estudiantes_rp + $costos_programacion->viaticos_docente_rp + $costos_programacion->valor_estimado_transporte_rp + $costos_programacion->vlr_materiales_rp + $costos_programacion->vlr_guias_baquianos_rp + $costos_programacion->vlr_otros_boletas_rp + $costos_programacion->costo_total_transporte_menor_rp, 0, ',','.') }}</td>
...
@if($tipo_ruta == 2)
    <table class="table table-bordered table-condensed table-hover table-sm header_table" cellspacing="0">
        ...
        <tr>
            <td>Servicio Transporte: </td>
            <td colspan="3">Nota: valor sujeto a contrato suscrito entre la facultad y las empresas de transporte. Se recomienda solicitar concepto en la decanatura para establecer costos del recorrido.</td>
            <td>{{ number_format($costos_programacion->valor_estimado_transporte_ra, 0, ',','.') }}</td>
            
        </tr>

        <tr>
            <td colspan="4">Total Presupuesto: </td>
            <td>{{ number_format($costos_programacion->viaticos_estudiantes_ra + $costos_programacion->viaticos_docente_ra + $costos_programacion->valor_estimado_transporte_ra + $costos_programacion->vlr_materiales_ra + $costos_programacion->vlr_guias_baquianos_ra + $costos_programacion->vlr_otros_boletas_ra + $costos_programacion->costo_total_transporte_menor_ra, 0, ',','.') }}</td>
