                        ...
                        <div class="col-md-12" style="padding-right: 0;">
                            <div class="input-group">
                                ...
                                <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
                                    <input id="hora_salida_rp" type="text" class="inputDate form-control datetimepickerHr @error('hora_salida_rp') is-invalid @enderror" name="hora_salida_rp" 
                                    style="padding-left: 0px;padding-right: 0px;border-top-left-radius: 0; border-bottom-left-radius: 0;margin-top: 1px;"
                                    value="{{$solicitud_practica->hora_salida}}" autocomplete="off" autofocus required placeholder="HH:mm" readonly>
                                </div>
                            </div>
                        </div>  
                    </div>
                ...
                <div class="input-group">
                    ...
                    <div class="row">
                        <div class="input-group">
                            ...
                            <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
                                <input id="hora_regreso_rp" type="text" class="inputDate form-control datetimepickerHr @error('hora_regreso_rp') is-invalid @enderror" name="hora_regreso_rp" 
                                style="padding-left: 0px;padding-right: 0px;border-top-left-radius: 0; border-bottom-left-radius: 0;margin-top: 1px;" required
                                value="{{$solicitud_practica->hora_regreso}}" autocomplete="off" autofocus required placeholder="HH:mm" readonly>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- 7 -->
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        ...
                        onclick="ver_vehic_transp('<?php echo $transporte_programacion->id_tipo_transporte_rp_1?>','<?php echo $transporte_programacion->id_tipo_transporte_rp_2?>','<?php echo $transporte_programacion->id_tipo_transporte_rp_3?>')">
            ...
            <div class="col-md-5">
                ...
                value="{{$transporte_programacion->docen_respo_trasnporte_rp}}" required autocomplete="off" autofocus readonly>
        ...
        <div class="form-group row" id="transporte_rp_1_edit">
            <div class="col-md-12" id="transporte_rp">
                <div class="row" id="transporte_rp_children">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_vehi_1}}" required autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 1') }}</label>
                        ...
                        value="{{$solicitud_transporte->celular_conductor_vehi_1}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_vehi_1}}" autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="placa_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique la placa del vehículo" style="font-size: 0.813rem"></i> {{ __('Placa Vehí.') }}</label>
                        <input id="placa_vehi_1" type="text" class="form-control @error('placa_vehi_1') is-invalid @enderror" name="placa_vehi_1" 
                        title=""
                        value="{{$solicitud_transporte->placa_vehi_1}}" required autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_2_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_2_vehi_1}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_2_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 2') }}</label>
                        ...
                        onchange="onlyNmb(this)" onkeyup="onlyNmb(this)"
                        value="{{$solicitud_transporte->celular_conductor_2_vehi_1}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_2_vehi_1" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_2_vehi_1}}"  autocomplete="off" autofocus>
        ...
        <div class="form-group row" id="transporte_rp_2_edit">
            <div class="col-md-12" id="transporte_rp">
                <div class="row" id="transporte_rp_children">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 1') }}</label>
                        ...
                        title=""
                        onchange="onlyNmb(this)" onkeyup="onlyNmb(this)"
                        value="{{$solicitud_transporte->celular_conductor_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="placa_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique la placa del vehículo" style="font-size: 0.813rem"></i> {{ __('Placa Vehí.') }}</label>
                        <input id="placa_vehi_2" type="text" class="form-control @error('placa_vehi_2') is-invalid @enderror" name="placa_vehi_2" 
                        title=""
                        value="{{$solicitud_transporte->placa_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_2_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_2_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_2_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 2') }}</label>
                        ...
                        title=""
                        onchange="onlyNmb(this)" onkeyup="onlyNmb(this)"
                        value="{{$solicitud_transporte->celular_conductor_2_vehi_2}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_2_vehi_2" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_2_vehi_2}}"  autocomplete="off" autofocus>
        ...
        <div class="form-group row" id="transporte_rp_3_edit">
            <div class="col-md-12" id="transporte_rp">
                <div class="row" id="transporte_rp_children">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 1') }}</label>
                        ...
                        title=""
                        onchange="onlyNmb(this)" onkeyup="onlyNmb(this)"
                        value="{{$solicitud_transporte->celular_conductor_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 1') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="placa_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique la placa del vehículo" style="font-size: 0.813rem"></i> {{ __('Placa Vehí.') }}</label>
                        <input id="placa_vehi_3" type="text" class="form-control @error('placa_vehi_3') is-invalid @enderror" name="placa_vehi_3" 
                        title=""
                        value="{{$solicitud_transporte->placa_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="nombre_cond_2_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el nombre del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Conductor Encargado 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->nombre_conductor_2_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <label for="celular_cond_2_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el número de celular del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Cel. Conductor 2') }}</label>
                        ...
                        title=""
                        onchange="onlyNmb(this)" onkeyup="onlyNmb(this)"
                        value="{{$solicitud_transporte->celular_conductor_2_vehi_3}}"  autocomplete="off" autofocus>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label for="email_cond_2_vehi_3" class="col-form-label text-md-left">
                            <i class="fas fa-question-circle" 
                            data-toggle="tooltip" data-placement="left" 
                            data-title="Indique el correo electrónico del conductor a cargo del vehículo" style="font-size: 0.813rem"></i> {{ __('Email Conductor 2') }}</label>
                        ...
                        title=""
                        value="{{$solicitud_transporte->email_conductor_2_vehi_3}}"  autocomplete="off" autofocus>
                        ...
                        <div class="col-md-12" style="padding-right: 0;">
                            <div class="input-group">
                                ...
                                <div class="col-md-7" style="padding-right: 0px;padding-left: 0px;">
                                    ...
                                    style="border-top-right-radius: 0; border-bottom-right-radius: 0"
                                    value="{{$programacion_practica->fecha_salida_aprox_ra}}" onchange="duracion_edit_RA(this.value)" disabled readonly> 
                                </div>
                                <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
                                    <input id="hora_salida_ra" type="text" class="inputDate form-control datetimepickerHr @error('hora_salida_ra') is-invalid @enderror" name="hora_salida_ra" 
                                    style="padding-left: 0px;padding-right: 0px;border-top-left-radius: 0; border-bottom-left-radius: 0;margin-top: 1px;"
                                    value="{{$solicitud_practica->hora_salida}}" autocomplete="off" autofocus required placeholder="HH:mm" readonly>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12" style="padding-right: 0;">
                            <div class="input-group">
                                ...
                                <div class="col-md-7" style="padding-right: 0px;padding-left: 0px;">
                                    ...
                                    style="border-top-right-radius: 0; border-bottom-right-radius: 0"
                                    value="{{$programacion_practica->fecha_regreso_aprox_ra}}" onchange="duracion_edit_RA(this.value)" readonly disabled> 
                                </div>
                                <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
                                    <input id="hora_regreso_ra" type="text" class="inputDate form-control datetimepickerHr @error('hora_regreso_ra') is-invalid @enderror" name="hora_regreso_ra" 
                                    style="padding-left: 0px;padding-right: 0px;border-top-left-radius: 0; border-bottom-left-radius: 0;margin-top: 1px;" required
                                    value="{{$solicitud_practica->hora_regreso}}" autocomplete="off" autofocus required placeholder="HH:mm" readonly>
                                </div>
                            </div>
