    ...
    <!-- 2 -->
        <div  class="form-group row">
            <div class="col-md-2">
                ...
                title="Número de estudiantes" onchange="calc_viaticos_RP()" onkeyup="onlyNmb(this)"
...
<!-- ruta principal -->
    ...
    <!-- materiales -->
        <div class="form-group row">
            <div class="col-md-8">
                <label for="det_materiales_rp" class="col-form-label text-md-left" title="Materiales" hidden>{{ __('Materiales') }}</label>
                {{-- <span class="hs-form-required">*</span> --}}
    ...
    <!-- 12 -->
        <div class="form-group row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                value="{{$programacion_practica->fecha_regreso_aprox_ra}}" readonly  onchange="duracion_edit_RA(this.value)" disabled readonly>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <!-- 4 -->
            ...
            <div class="col-md-1">
                <div class="form-group" style="margin-right: 15px;">
                    <label class="switch">
                        <input type="checkbox" name="certificado_adicional_1" id="certificado_adicional_1" onchange="documAdicional(this,1)">
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="row col-md-6">
                ...
                <div class="col-md-9" id="cert_adic_1">
                    ...
                    style="margin-top: -0.6rem" value="" autocomplete="off" autofocus >
        ...
        <!-- 5 -->
            ...
            <div class="col-md-1">
                <div class="form-group" style="margin-right: 15px;">
                    <label class="switch">
                        <input type="checkbox" name="certificado_adicional_2" onchange="documAdicional(this,2)">
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
        ...
        <!-- 6 -->
            ...
            <div class="col-md-1">
                <div class="form-group" style="margin-right: 15px;">
                    <label class="switch">
                        <input type="checkbox" name="certificado_adicional_3" onchange="documAdicional(this,3)">
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
