...
<!-- end HTML HEAD -->
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Perfil Usuario') }}</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="primer_nombre" class="col-form-label text-md-left">
                                            {{ __('Primer Nombre') }}</label>
                                        <input id="primer_nombre" type="text" class="form-control @error('primer_nombre') is-invalid @enderror" 
                                        name="primer_nombre" value="{{ $usuario->primer_nombre }}" required autocomplete="primer_nombre" autofocus readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="segundo_nombre" type="text" class="form-control @error('segundo_nombre') is-invalid @enderror" 
                                        name="segundo_nombre" value="{{ $usuario->segundo_nombre }}" autocomplete="segundo_nombre" autofocus readonly>
                                    ...
                                    <div class="col-md-3">
                                        <label for="primer_apellido" class="col-form-label text-md-right">
                                            {{ __('Primer Apellido') }}</label>
                                        <input id="primer_apellido" type="text" class="form-control @error('primer_apellido') is-invalid @enderror" 
                                        name="primer_apellido" value="{{ $usuario->primer_apellido }}" required autocomplete="primer_apellido" autofocus readonly>
                                    ...
                                    <div class="col-md-3">
                                        <label for="segundo_apellido" class="col-form-label text-md-right">
                                            {{ __('Segundo Apellido') }}</label>
                                        <input id="segundo_apellido" type="text" class="form-control @error('segundo_apellido') is-invalid @enderror" 
                                        name="segundo_apellido" value="{{ $usuario->segundo_apellido }}" autocomplete="segundo_apellido" autofocus readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="id_tipo_identificacion" class="form-control" required readonly disabled>
                                            ...
                                            <option <?php if($tip_ident->id==$usuario->id_tipo_identificacion) echo 'selected'?> 
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="num_identificacion"  class="form-control @error('num_identificacion') is-invalid @enderror" 
                                        name="num_identificacion" value="{{ $usuario->id }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="expedicion_identificacion"  class="form-control @error('expedicion_identificacion') is-invalid @enderror"
                                        name="expedicion_identificacion" 
                            ...
                            <!-- 3 -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        value="{{ $usuario->email }}" required autocomplete="off"
                                        readonly>
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        name="telefono" value="{{ $usuario->telefono }}" autocomplete="off" readonly>
                                        @error('telefono')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        name="celular" value="{{ $usuario->celular }}" required autocomplete="off" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="id_role" class="col-form-label text-md-right">
                                            {{ __('Tipo Usuario') }}</label>
                                        <select name="id_role" class="form-control" required disabled>
                                    ...
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_coord" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico Coord.') }}</label>
                                        <select name="id_programa_academico_coord" class="form-control" id="id_programa_academico_coord" required disabled>
                                    ...
                                    <div class="col-md-3">
                                        <label for="id_tipo_vinculacion" class="col-form-label text-md-right">
                                            {{ __('Vinculación') }}</label>
                                        <select name="id_tipo_vinculacion" class="form-control" required disabled>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2" >
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$usuario->cant_espacio_academico}}" autocomplete="off" autofocus onchange="" readonly disabled>
                                ...
                                <div class="form-group row" id="esp_aca_user_1_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]" id="id_programa_academico_1" class="form-control" required onchange="searchEspaAca_2(1)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        onchange="searchEspaAca(this.value,1)" readonly/>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <!-- 6 Academico_2 -->
                                ...
                                <div class="form-group row"  id="esp_aca_user_2_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]"  id="id_programa_academico_2" class="form-control" onchange="searchEspaAca_2(2)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
                                    ...
                                    <input type="text" name="cod_espacio_academico_[]" id="cod_espacio_academico_[]" value="{{$espacios_usuario[1]['codigo_espacio_academico']}}" class="form-control"
                                        onchange="searchEspaAca(this.value,2)" readonly/>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <!-- 6 Academico_3 -->
                                ...
                                <div class="form-group row"  id="esp_aca_user_3_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]"  id="id_programa_academico_3" class="form-control"onchange="searchEspaAca_2(3)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        onchange="searchEspaAca(this.value,3)" readonly/>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <!-- 6 Academico_4 -->
                                ...
                                <div class="form-group row" id="esp_aca_user_4_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]" id="id_programa_academico_4"  class="form-control" required onchange="searchEspaAca_2(4)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
                            ...
                            <!-- 6 Academico_5 -->
                                ...
                                <div class="form-group row"  id="esp_aca_user_5_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]" id="id_programa_academico_5"  class="form-control" required onchange="searchEspaAca_2(5)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
                            ...
                            <!-- 6 Academico_6 -->
                                ...
                                <div class="form-group row"  id="esp_aca_user_6_edit">
                                    <div class="col-md-3">
                                        <label for="id_programa_academico_[]" class="col-form-label text-md-right">
                                            {{ __('Prog. Académico') }}</label>
                                        <select name="id_programa_academico_[]" id="id_programa_academico_6"  class="form-control" required onchange="searchEspaAca_2(6)" disabled>
                                            @foreach($programas_academicos as $pr_aca)
