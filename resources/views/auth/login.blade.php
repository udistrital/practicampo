                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="usuario" class="col-md-4 col-form-label text-md-right">
                                        <i class="fas fa-question-circle" 
                                            ...
                                            data-title="Ingrese el usuario registrado"
                                            style="font-size: 0.813rem">
                                        </i> {{ __('Usuario') }}</label>

                                    <div class="col-md-6">
                                        <input id="usuario" type="usuario" class="form-control @error('usuario') is-invalid @enderror" 
                                        name="usuario" value="{{ old('usuario') }}" required autocomplete="usuario" autofocus title="">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-form-label text-md-right">
                                        <i class="fas fa-question-circle" 
                                            data-toggle="tooltip" data-placement="left" 
                                            data-title="Ingrese la contraseña registrada"
                                            style="font-size: 0.813rem">
                                        </i> {{ __('Password') }}</label>
