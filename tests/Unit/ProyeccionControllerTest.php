...
class ProyeccionControllerTest extends TestCase
{
    ...
    /**
     * Prueba unitaria del método filterProyeccion del controlador ProyeccionController
     */
    public function test_proyeccion_filterProyeccion(): void{
        $user = User::find(79794356);
        $this->actingAs($user);
        $proyeccion = proyeccion::find(1170);
        $filter = 'all';
        $response = $this->get("proyecciones/filtrar/{$filter}");
        $response->assertStatus(200);
        $response->assertViewIs('proyecciones.index'); 
    }

    /**
     * Prueba unitaria del método store del controlador ProyeccionController
     */
    public function test_proyeccion_store(): void {
        $user = User::find(79794356);
        $this->actingAs($user);
        ...
        $response = $this->post('proyecciones', $data);

        $response->assertStatus(302);
        $response->assertRedirect('proyecciones/filtrar/all');

        //$this->assertDatabaseHas('proyeccion_preliminar', [
        //    'id' => ,
        //]);
    }

    /**
     * Prueba unitaria del método edit del controlador ProyeccionController
     */
    public function test_proyeccion_edit(): void{
        $user = User::find(79794356);
        $this->actingAs($user);
        $proyeccion = proyeccion::find(1170);
        $id = Crypt::encrypt($proyeccion->id);
        $response = $this->get("proyecciones/{$id}");
        $response->assertStatus(200);
        $response->assertViewIs('proyecciones.edit'); 
    }

    /**
     * Prueba unitaria del método update del controlador ProyeccionController
     */
    public function test_proyeccion_update(): void{
        $user = User::find(79794356);
        $this->actingAs($user);
        $proyeccion = proyeccion::find(1170);
        $id = Crypt::encrypt($proyeccion->id);
        ...
        $response = $this->put("proyecciones/{$id}", $data);

        $response->assertStatus(302);
        $response->assertRedirect('proyecciones/filtrar/not_send');
    }
    
    /**
     * Prueba unitaria del método update del controlador ProyeccionController para coordinador
     */
    public function test_proyeccion_update_coordinador(): void{
    ...
    /**
     * Prueba unitaria del método update del controlador ProyeccionController para decano
     */
    public function test_proyeccion_update_decano(): void{
        ...
        $response->assertStatus(302);
        $response->assertRedirect('proyecciones/filtrar/pend');
    }
    /**
     * Prueba unitaria del método update del controlador ProyeccionController para asistente
     */
    public function test_proyeccion_update_asistente(): void{
